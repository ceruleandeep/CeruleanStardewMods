...
namespace FarmersMarket.Utility
{
    ...
    class ConsoleCommands
    {
        ...
        private void ConditionCheck(string arg1, string[] arg2)
        {
            ...
            FarmersMarket.monitor.Log($"Expression resolved as: {APIs.Conditions.CheckConditions(condition)}",LogLevel.Info);
        }
        ...
        private void DisplayShopMenu(string command, string[] args)
        {
            if (args.Length == 0)
            {
                FarmersMarket.monitor.Log($"A shop name is required", LogLevel.Debug);
                return;
            }
            ...
            else
            {
                ...
                {
                    FarmersMarket.monitor.Log($"The player isn't free to act; can't display a menu right now", LogLevel.Debug);
                    return;
                }
        ...
        private void ResetShopStock(string command, string[] args)
        {
            ...
            else
            {
                ...
                {
                    FarmersMarket.monitor.Log($"The world hasn't loaded; shop stock can't be updated at this time", LogLevel.Debug);
                    return;
                }
        ...
        private void ListAllShops(string command, string[] args)
        {
            ...
            else
            {
                ...
                FarmersMarket.monitor.Log(temp, LogLevel.Debug);
            }
        }
